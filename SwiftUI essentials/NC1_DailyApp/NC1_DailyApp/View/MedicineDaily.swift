...
//     ]),
            ...
            Medicine(date: Date(),
                     medicineDetail: [
                        MedicineDetail(medicineName: "Medicine 4",
                                                    medicineType: .capsule,
                                                    medicineVolume: 3,
                                                    medicineUnit: .gram,
                                                    medicineFrequency: 1,
                        ...
                        MedicineDetail(medicineName: "Medicine 3",
                                                    ...
                                                    backgroundColor: "White")],
                     painDetail: [
                        PainDetail(painPart: ArticulationList.chin,
                                            painPartNumber: FingerAndToesNum.first,
                                            painPartAttendants: ArticulationDirection.left,
                                            painDegree: 1,
                                            painDate: Date())]),
            Medicine(date: Date(),
                     medicineDetail: [
                        MedicineDetail(medicineName: "Medicine 5",
                                                    medicineType: .capsule,
                                                    medicineVolume: 3,
                                                    medicineUnit: .gram,
                                                    medicineFrequency: 1,
                        ...
                        MedicineDetail(medicineName: "Medicine 3",
                                                    ...
                                                    backgroundColor: "White")],
                     painDetail: [
                        PainDetail(painPart: ArticulationList.ankle,
                                            painPartNumber: FingerAndToesNum.first,
                                            painPartAttendants: ArticulationDirection.right,
                                            painDegree: 1,
                                            painDate: Date())]),
            Medicine(date: Date(),
                     medicineDetail: [
                        MedicineDetail(medicineName: "Medicine 6",
                                                    medicineType: .capsule,
                                                    medicineVolume: 3,
                                                    medicineUnit: .gram,
                                                    medicineFrequency: 1,
            ...
            Medicine(date: Date(),
                     medicineDetail: [
                        MedicineDetail(medicineName: "Medicine 7",
                                                    medicineType: .capsule,
                                                    medicineVolume: 3,
                                                    medicineUnit: .gram,
                                                    medicineFrequency: 1,
                        ...
                        MedicineDetail(medicineName: "Medicine 3",
                                                    ...
                                                    backgroundColor: "White")],
                     painDetail: [
                        PainDetail(painPart: ArticulationList.shoulder,
                                            painPartNumber: FingerAndToesNum.first,
                                            painPartAttendants: ArticulationDirection.right,
                                            painDegree: 1,
                                            painDate: Date())]),
            Medicine(date: Date(),
                     medicineDetail: [
                        MedicineDetail(medicineName: "Medicine 8",
                                                    medicineType: .capsule,
                                                    medicineVolume: 3,
                                                    medicineUnit: .gram,
                                                    medicineFrequency: 1,
